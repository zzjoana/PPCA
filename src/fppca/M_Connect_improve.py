...
# D = 17
# NR_b = 25
join_1 = """create table join_result AS select * from "s5" join "r25" on "s5"."fk"= "r25"."rid" order by "rid","sid";"""
NR_1 = """select * from "r25";"""
mu_1 = """select avg("xs1"), avg("xs2"),avg("xr1"), avg("xr2"),avg("xr3"), avg("xr4"), avg("xr5"), avg("xr6")
          from "join_result";"""
data_1 = """select  "xs1", "xs2", "rid", "xr1", "xr2","xr3", "xr4", "xr5", "xr6" 
          from "join_result";"""

join_2 = """create table join_result AS select * from "s6" join "r25" on "s6"."fk"= "r25"."rid" order by "rid","sid";"""
NR_2 = """select * from "r25";"""
mu_2 = """select avg("xs1"), avg("xs2"),avg("xr1"), avg("xr2"),avg("xr3"), avg("xr4"), avg("xr5"), avg("xr6")
          from "join_result";"""
data_2 = """select  "xs1", "xs2", "rid", "xr1", "xr2","xr3", "xr4", "xr5", "xr6"
          from "join_result";"""

join_3 = """create table join_result AS select * from "s7" join "r25" on "s7"."fk"= "r25"."rid" order by "rid","sid";"""
NR_3 = """select * from "r25";"""
mu_3 = """select avg("xs1"), avg("xs2"),avg("xr1"), avg("xr2"),avg("xr3"), avg("xr4"), avg("xr5"), avg("xr6")
         from "join_result";"""
data_3 = """select  "xs1", "xs2", "rid", "xr1", "xr2","xr3", "xr4", "xr5", "xr6"
          from "join_result";"""

join_4 = """create table join_result AS select * from "s8" join "r25" on "s8"."fk"= "r25"."rid" order by "rid","sid";"""
NR_4 = """select * from "r25";"""
mu_4 = """select avg("xs1"), avg("xs2"),avg("xr1"), avg("xr2"),avg("xr3"), avg("xr4"), avg("xr5"), avg("xr6")
          from "join_result";"""
data_4 = """select  "xs1", "xs2", "rid", "xr1", "xr2","xr3", "xr4", "xr5", "xr6"
          from "join_result";"""

join_5 = """create table join_result AS select * from "s9" join "r25" on "s9"."fk"= "r25"."rid" order by "rid","sid";"""
NR_5 = """select * from "r25";"""
mu_5 = """select avg("xs1"), avg("xs2"),avg("xr1"), avg("xr2"),avg("xr3"), avg("xr4"), avg("xr5"), avg("xr6")
          from "join_result";"""
data_5 = """select  "xs1", "xs2", "rid", "xr1", "xr2","xr3", "xr4", "xr5", "xr6"
          from "join_result";"""

join_sql_list = [join_1, join_2, join_3, join_4, join_5]
NR_sql_list = [NR_1, NR_2, NR_3, NR_4, NR_5]
mu_sql_list = [mu_1, mu_2, mu_3, mu_4, mu_5]
data_sql_list = [data_1, data_2, data_3, data_4, data_5]
D_list = [8, 8, 8, 8, 8]
runtime_list = []
cputime_list = []
fetchdatatime_list = []
...
for i in range(4,len(join_sql_list)):
    print("i=", i)
