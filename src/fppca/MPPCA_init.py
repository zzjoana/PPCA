...
class MPPCA_IN(object):
    def __init__(self, P, Sigma, max_iter):
    ...
    def expectation_maximization(self):
        ...
        for i in range(self.max_iter):
            ...
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!W_new:\n", W_new)
            for n in range(N):
                Sigma_p1[:, [n]] = np.square(np.linalg.norm(X[[n], :] - mu))
                # print("(X[", n, "] - mu).T:\n", (X[[n], :] - mu).T)
                # print("Sigma_p1[:,", n, "]:\n", Sigma_p1[:, [n]])
            ...
            sigma2_new = (1 / (self.N * self.D)) * (np.sum(Sigma_p1) - np.sum(sigma2_p2) + np.sum(sigma2_p3))
            print("!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!sigma2_new:\n", sigma2_new)
